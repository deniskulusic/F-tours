...
function validateForm() {
  ...
  if(currentTab==1){
    ...
    zx=x[currentTab].querySelector(".checkbox div");
    if(z.checked==false){
        valid = false;
  ...
  if(currentTab==3){
   var qw=x[currentTab].querySelectorAll('input[name="fav_language"]');
   ...
   var zq=x[currentTab].querySelectorAll(".checkbox div");
    ...
    if(!(y[6].value.match(validRegex))){
      y[6].className += " invalid";
      valid = false;
    }
    if(!(y[5].value.match(validnum))){
...
var x = document.getElementsByClassName("tab");
  ...
  var zx=x[1].querySelector(".checkbox div");
  ...
  var yx=x[2].querySelectorAll('input[name="spol"]');
   var xy=x[2].querySelectorAll(".big label");
      ...
      var qw=x[3].querySelectorAll('input[name="fav_language"]');
      ...
      var zw=x[3].querySelectorAll(".checkbox div");
